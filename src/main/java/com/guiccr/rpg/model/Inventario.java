...
public class Inventario {
    ...
    public void exibirItens() {
        ...
        // import com.guiccr.rpg.ConsoleColors; // Commented out as it may not be needed in the new package structure
    public void aplicarEfeitoItem(int indice, Heroi heroi){
        ...
        // Impede que equipamentos sejam usados como itens
        if (item instanceof Equipavel) {
            System.out.println(ConsoleColors.RED + "Este item é um equipamento e deve ser equipado, não usado!" + ConsoleColors.RESET);
            return;
        }
